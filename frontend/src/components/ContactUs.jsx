    ...
    <div className="isolate bg-white px-6 py-24 sm:pt-4 pb-32 lg:px-8 drop-shadow-lg " >
      ...
      <form ref={form} onSubmit={sendEmail} action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-lightPrimary p-3 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-lightPrimary p-8 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Let's talk
          </button>
        </div>
