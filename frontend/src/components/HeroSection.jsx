  ...
  return (
    ...
    >
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6 mt-24 p-8">
        ...
        <div className="text-center md:w-[85%] flex flex-wrap gap-4 md:gap-3 justify-center" >
          <input
            type="text"
            className="md:w-3/4 border px-2 py-3 rounded-lg "
            placeholder="Search Jobs"
          />
          <button className="bg-lightPrimary text-lightCard md:px-7 px-4 py-3   text-sm rounded-lg">
            Search
          </button>
        </div>
      </div>
